...
fl_funcs_proj.pil_poly_plot(X, Y, pil_mask_c, hmi_dat, ivs, dvs, conv_f,
                            xarr_Mm, yarr_Mm, flnum)
...
fl_funcs_proj.elon_period_plot(dpos_len, dneg_len, times, times1600,
                               lens_pos_Mm, lens_neg_Mm, flnum,
                               elonperiod_start_neg, elonperiod_start_pos,
                               elonperiod_end_neg, elonperiod_end_pos)

print("Plotting Separation with Periods")

indstrt = 25
fl_funcs_proj.sep_period_plot(dpos_dist, dneg_dist, times, distpos_Mm,
                              distneg_Mm, flnum, sepperiod_start_pos,
                              sepperiod_end_pos, sepperiod_start_neg,
...
fl_funcs_proj.exp_curve_plt(dt1600, rec_flux_pos, rec_flux_neg, rise_pos_flx,
                            ...
                            exponential, exponential_neg, poptposflx,
                            poptnegflx, flnum)
...
pos_gvar, neg_gvar = fl_funcs_proj.pltgvarex(pos_area, neg_area, pos_unc,
                                             neg_unc, times, flnum)
fitpos, fitneg = fl_funcs_proj.lsqarea(modstrt, modend, exp_for_lsqfit,
